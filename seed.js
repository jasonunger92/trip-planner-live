...
var data = {
  ...
  Restaurant: [
    {name: "Bouley", place: new Place({address: "75 Wall St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.705137, -74.013940]}), cuisines: "French", price: 4},
    {name: "Marc Forgione", place: new Place({address: "134 Reade St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.716526, -74.009567]}), cuisines: "Seafood", price: 3},
    {name: "Tamarind", place: new Place({address: "99 Hudson St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.718977, -74.008929]}), cuisines: "Indian", price: 3},
    {name: "Hop Lee Restaurant", place: new Place({address: "16 Mott St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.714230, -73.998509]}), cuisines: "Chinese", price: 2},
    {name: "Jungsik", place: new Place({address: "2 Harrison St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.718679, -74.008900]}), cuisines: "Korean", price: 4},
    {name: "The Capital Grille", place: new Place({address: "120 Broadway", city: "New York", state: "NY", phone: "123-456-7890", location: [40.708475, -74.010846]}), cuisines: "Steakhouses, American", price: 4},
    {name: "Pylos", place: new Place({address: "128 E 7th St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.726096, -73.984152]}), cuisines: "Greek", price: 3},
    {name: "Joe's Shanghai", place: new Place({address: "9 Pell St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.714601, -73.997761]}), cuisines: "Shanghainese, Dim Sum", price: 2},
    {name: "Cafe Katja", place: new Place({address: "79 Orchard St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.717719, -73.990565]}), cuisines: "German, Austrian", price: 2},
    {name: "Rosanjin", place: new Place({address: "141 Duane St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.716403, -74.007724]}), cuisines: "Japanese", price: 3},
    {name: "Kittichai", place: new Place({address: "60 Thompson St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.724014, -74.003242]}), cuisines: "Thai", price: 4},
    {name: "Bianca Restaurant", place: new Place({address: "5 Bleecker St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.725495, -73.992662]}), cuisines: "Italian", price: 2},
    {name: "Rayuela", place: new Place({address: "165 Allen St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.721266, -73.989756]}), cuisines: "Spanish, Latin American", price: 3},
    {name: "Mas Farmhouse", place: new Place({address: "39 Downing St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.729269, -74.003875]}), cuisines: "New American, French", price: 4},
    {name: "Xe Lua", place: new Place({address: "86 Mulberry St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.716544, -73.998626]}), cuisines: "Vietnamese", price: 1}
  ],
  Activity: [
    ...
    {name: "Staten Island Ferry Whitehall Terminal", place: new Place({address: "4 S St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.701144, -74.013020]}), age_range: "All" },
